...
use crate::{domain::{Deployment, Stack, TDeploymentRepository}, system, yaml};
...
impl TerraformDeployer {
    pub fn new(root: &std::path::PathBuf) -> Self {
        Self {
            deployment_repository: Box::new(crate::infra::repositories::deployment::InMemoryDeploymentRepository::new(root)),
        }
    }
}
